...
export const generalTitle = 'General and parking';
...
export const poolTitle = 'Beach and pool';
...
export const transportTitle = 'Parking and transport';
...
export const locationTitle = 'Distance to:';
